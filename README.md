...
В таблице статусов транзакций не проверялся индекс состояния транзакции Не завершена, возможно нужен 0.
...
При завершении чтения и запуске снова чтение продолжается с последней записи(при соответствующих настройках).
